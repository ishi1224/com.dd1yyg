...
import com.dd1yyg.shop.model.PayReturnModel;
import com.dd1yyg.shop.utils.HttpUtil;
import com.dd1yyg.shop.utils.LogUtil;
import com.dd1yyg.shop.utils.OrderUtil;
import com.dd1yyg.shop.utils.ToastUtil;
    ...
    * */
    ...
    private String genStringEntity(String params){
        ...
        try {
            ...
            model.setTrade_type(OrderUtil.getTradeType());//**是 交易类型
